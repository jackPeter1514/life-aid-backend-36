...
import { Calendar, Building2, TestTube, User, LogOut, FileText } from "lucide-react";
              ...
              <div className="space-y-4">
                {appointments.slice(0, 3).map((appointment) => (
                  <div key={appointment._id} className="flex items-center justify-between p-4 border rounded-lg">
                    <div>
                      <h4 className="font-semibold">{appointment.testId.name}</h4>
                      <p className="text-sm text-muted-foreground">{appointment.diagnosticCenterId.name}</p>
